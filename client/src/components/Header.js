    ...
    <nav
      className={`${
        scrolledHeader
          ...
          : `bg-transparent`
      } px-2 sm:px-4 py-0.5 fixed w-full z-20`}
    >
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div
          ...
          id="navbar-sticky"
        >
          <ul className="flex flex-col p-4 mt-4 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-lg md:font-medium md:border-0">
            <li>
              <a
                href="#"
