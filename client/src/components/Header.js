...
const Header = () => {
  ...
  return (
    <nav
      className={`${
        scrolledHeader
          ? `top-0 border-b border-gray-200 bg-white`
          : `bg-transparent`
      } px-2 py-1 sm:px-4 py-0.5 fixed w-full z-20`}
    >
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <a href="#" className="flex items-center">
          <span className="self-center text-2xl lg:text-4xl whitespace-nowrap">
            MINT
          </span>
        </a>
        <div className="flex items-center md:order-2">
          <a href="https://flowbite.com/">
            <svg
              className="hidden md:block w-5 mr-3"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
            >
        ...
        <div
          ...
          id="navbar-sticky"
        >
          <ul className="flex flex-col p-4 mt-4 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-2xl md:border-0">
            <li>
              <a
                href="#"
